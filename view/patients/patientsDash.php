<?php
session_start();
if (isset($_SESSION['login_success']['fname'])) {
  $fname = $_SESSION['login_success']['fname'];
  $phone = $_SESSION['login_success']['phone'];
  $email = $_SESSION['login_success']['email'];
  $dob = $_SESSION['login_success']['dob'];
  $gender = $_SESSION['login_success']['gender'];
  $address = $_SESSION['login_success']['address'];
} else {
  echo "NO DATA";
}
    ...
    <div class="main-content-area">
      <aside class="sidebar scroll-container" id="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li>
            <a href="#" class="menu-item" data-content="doctors"><i class="fas fa-user-md"></i> View & Book Doctors</a>
          </li>
          <li>
            <a href="#" class="menu-item" data-content="records"><i class="fas fa-file-medical-alt"></i> Medical Records</a>
          </li>
          <li>
            <a href="#" class="menu-item" data-content="notifications"><i class="fas fa-bell"></i> Notifications</a>
          </li>
          <li>
      ...
      <main class="content-display" id="contentDisplay">
        <section id="content-home" class="dashboard-section dashboard-home">
          ...
          <div class="summary-cards">
            <div class="card">
              ...
              <p>3</p>
              <button class="button" onclick="loadContent('appointments')">View Details</button>
            </div>
            <div class="card">
            ...
            <div class="card">
              ...
              <p>2</p>
              <button class="button" onclick="loadContent('notifications')">View Details</button>
            </div>
            <div class="card">
              <h4>Total Doctors</h4>
              <p>8</p>
              <button class="button" onclick="loadContent('doctors')">View Details</button>
            </div>
          </div>
          ...
          <div style="margin-top: 3.2rem; text-align: left; background-color: #f0f4f8; padding: 2.4rem; border-radius: 1rem">
            <h3>Quick Actions</h3>
            <p>
              <a href="#" class="button button-secondary" onclick="loadContent('doctors')">Book New Appointment</a>
              <a href="#" class="button" onclick="loadContent('records')">View My Records</a>
            </p>
          </div>
        </section>
        ...
        <section id="content-doctors" class="dashboard-section" style="display: none">
          ...
          <p>Find the right specialist for your needs. Click 'Book Now' to schedule an appointment or 'View Details' for more information.</p>
        ...
        <section id="content-records" class="dashboard-section" style="display: none">
          ...
          <div style="background-color: #f0f4f8; padding: 2rem; border-radius: 0.8rem; margin-top: 2rem">
            ...
            <ul>
              <li>Medication A - 20mg, Once Daily - Prescribed by Dr. Smith (May 2025)</li>
              <li>Medication B - 500mg, Twice Daily - Prescribed by Dr. Watson (April 2025)</li>
            </ul>
            <p style="margin-top: 1.5rem">
              <strong>Recent Test Results:</strong>
            </p>
            <ul>
              <li>Complete Blood Count - Normal (June 2025)</li>
              <li>Lipid Panel - Within Range (March 2025)</li>
            </ul>
            <p style="margin-top: 1.5rem"><strong>Past Diagnoses:</strong></p>
            <ul>
              <li>Seasonal Allergies (August 2024)</li>
              <li>Common Cold (January 2025)</li>
            </ul>
          </div>
        </section>

        <section id="content-notifications" class="dashboard-section" style="display: none">
          <h2>My Notifications</h2>
          <p>Stay updated with the latest alerts and messages from the hospital.</p>
          <div style="background-color: #f0f4f8; padding: 2rem; border-radius: 0.8rem; margin-top: 2rem">
            <ul>
              <li><strong>June 18, 2025:</strong> Your appointment with Dr. Emily Watson tomorrow at 2:00 PM is confirmed.</li>
              <li><strong>June 15, 2025:</strong> New lab results are available for review in your Medical Records.</li>
              <li><strong>June 10, 2025:</strong> Reminder: Annual check-up due next month. Schedule now!</li>
            </ul>
          </div>
        </section>
            ...
            <form id="profileForm" method="post" action="save_profile.php">
              <div class="profile-form-row">
                <div class="form-group">
                  ...
                  <input type="text" id="profileName" name="fname" value="<?php echo htmlspecialchars($fname); ?>" disabled />
                </div>
                <div class="form-group">
                  <label for="profilePhone">Phone Number:</label>
                  <input type="tel" id="profilePhone" name="phone" value="<?php echo htmlspecialchars($phone); ?>" disabled />
                </div>
              </div>

              <div class="form-group">
                <label for="profileEmail">Email:</label>
                <input type="email" id="profileEmail" name="email" value="<?php echo htmlspecialchars($email); ?>" disabled />
              </div>

              <div class="form-group">
                <label for="profileAddress">Address:</label>
                <textarea id="profileAddress" rows="2" name="address" disabled><?php echo htmlspecialchars($address); ?></textarea>
              </div>
                  <div class="profile-form-row">
                    <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="date" id="profileDob" name="dob" value="<?php echo htmlspecialchars($dob); ?>" disabled />
              </div>
